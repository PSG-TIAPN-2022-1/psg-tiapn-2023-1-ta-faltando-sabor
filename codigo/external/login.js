...
{   
localStorage.setItem("admin", emailCad);
localStorage.setItem("admin123", senhacad);
...
if(emailLogin == localStorage.getItem("admin") && senhaLogin == localStorage.getItem("admin123")){
